...
////
A_TYPE *setTypeElementType(A_TYPE *, A_TEYP *);
	...
	switch (id->kind) {
		case ID_VAR:
			...
			if (id->level == 0) { 
				...
				sem_initializer(id->init, ide->level);
			}
